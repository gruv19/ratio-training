...
function setPlayPauseHandler(handler: any, thisArg: Game): void {
...
function setResetGameHandler(handler: any, thisArg: Game): void {
...
function setSaveUsernameHandler(handler: any, thisArg: Game): void {
